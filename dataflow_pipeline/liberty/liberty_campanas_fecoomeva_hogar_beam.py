...
class formatearData(beam.DoFn):
	...
	def process(self, element):
		...
		tupla= {'idkey' : str(uuid.uuid4()),
				...
				'MES_CANDIDATO' : arrayCSV[19],
				'ESTADO' : arrayCSV[20],
				'NOMBRE_DE_CAMPANA' : arrayCSV[21],
				'IPDIAL_CODE' : arrayCSV[22]
...
def run(archivo, mifecha, id_campana):
	...
	transformed | 'Escritura a BigQuery liberty_campanas' >> beam.io.WriteToBigQuery(
		gcs_project + ":telefonia.liberty_campanas_fecoomeva_hogar", 
		schema=TABLE_SCHEMA, 
