...
class formatearData(beam.DoFn):
	...
	def process(self, element):
		...
		tupla= {'ID_AFIRMACION' : arrayCSV[0],
                'DESC_AFIRMACION' : arrayCSV[1]
				}
...
def run():
	...
	lines = pipeline | 'Lectura de Archivo' >> ReadFromText(gcs_path + "/Clima/afirmaciones" + ".csv")
	...
	transformed | 'Escritura a BigQuery Felicidad_y_Cultura' >> beam.io.WriteToBigQuery(
        gcs_project + ":Felicidad_y_Cultura.Afirmaciones",
        schema=TABLE_SCHEMA,
