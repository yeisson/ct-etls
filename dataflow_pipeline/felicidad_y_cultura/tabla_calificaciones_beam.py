...
class formatearData(beam.DoFn):
	...
	def process(self, element):
		...
		tupla= {'ID_REGISTRO' : arrayCSV[0],
                ...
                'ID_AFIRMACION' : arrayCSV[2],
                'NOTA' : arrayCSV[3],
                'FECHA_REGISTRO' : arrayCSV[4]
...
def run():
	...
	lines = pipeline | 'Lectura de Archivo' >> ReadFromText(gcs_path + "/Clima/calificaciones" + ".csv")
	...
	transformed | 'Escritura a BigQuery Felicidad_y_Cultura' >> beam.io.WriteToBigQuery(
        gcs_project + ":Felicidad_y_Cultura.Calificaciones",
        schema=TABLE_SCHEMA,
