...
class formatearData(beam.DoFn):
	...
	def process(self, element):
		...
		tupla= {'ID_CRITERIO' : arrayCSV[0],
                'DESCRIPCION_CRITERIO' : arrayCSV[1]
...
def run():
	...
	lines = pipeline | 'Lectura de Archivo' >> ReadFromText(gcs_path + "/Clima/criterio" + ".csv")
	...
	transformed | 'Escritura a BigQuery Felicidad_y_Cultura' >> beam.io.WriteToBigQuery(
        gcs_project + ":Felicidad_y_Cultura.Criterio",
        schema=TABLE_SCHEMA,
