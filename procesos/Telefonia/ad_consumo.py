...
ad_consumo_api = Blueprint('ad_consumo_api', __name__) #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]
...
@ad_consumo_api.route("/" + KEY_REPORT, methods=['GET']) #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]
def Ejecutar():
    ...
    QUERY = (
        'SELECT servidor, operacion, token, ipdial_code, id_cliente  FROM `contento-bi.telefonia.parametros_ipdial` where operacion = "Bancolombia Consumo" and Estado = "Activado" ') #WHERE ipdial_code = "intcob-unisabaneta"
    ...
    try:
        ...
        QUERY2 = ('delete FROM `contento-bi.telefonia.ad_consumo` where CAST(substr(date,0,10) AS DATE) = ' + '"' + dateini[0:4] + '-' + dateini[4:-8] + '-' + dateini[6:-6] + '"')
...
@ad_consumo_api.route("/" + KEY_REPORT + "_recov", methods=['GET']) #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]
def Ejecutar2():
