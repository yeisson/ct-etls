...
import time
import sys
import dataflow_pipeline.telefonia.ivr_beam as ivr_beam #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]

ivr_api = Blueprint('ivr_api', __name__) #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]
...
@ivr_api.route("/" + KEY_REPORT, methods=['GET']) #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]
def Ejecutar():
    ...
    try:
        ...
        QUERY2 = ('delete FROM `contento-bi.telefonia.ivr` where CAST(date AS DATE) = ' + '"' + dateini[0:4] + '-' + dateini[4:-8] + '-' + dateini[6:-6] + '"')
        ...
        if len(requests.get(url).content) < 50:
            ...
            for rown in i:
                file.write(
                    str(rown["operation"])+"|"+
                    str(rown["ivr"])+"|"+
                    str(rown["ivr_duration"])+"|"+
                    str(rown["cod_opc_men"]).encode('utf-8')+"|"+
