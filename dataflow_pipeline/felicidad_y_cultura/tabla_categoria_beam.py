...
class formatearData(beam.DoFn):
	...
	def process(self, element):
		...
		tupla= {'ID_CATEGORIA' : arrayCSV[0],
                'DESC_CATEGORIA' : arrayCSV[1]
...
def run():
	...
	lines = pipeline | 'Lectura de Archivo' >> ReadFromText(gcs_path + "/Clima/categoria" + ".csv")
	...
	transformed | 'Escritura a BigQuery Felicidad_y_Cultura' >> beam.io.WriteToBigQuery(
        gcs_project + ":Felicidad_y_Cultura.Categoria",
        schema=TABLE_SCHEMA,
