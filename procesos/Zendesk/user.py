...
import time
import sys
import dataflow_pipeline.Ofima.user_beam as user_beam #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]
...
@user_api.route("/" + KEY_REPORT, methods=['GET']) #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]
def Ejecutar():
    ...
    try:
     QUERY = (
         'Delete `contento-bi.Ofima_sac.user` where id is not null ') #WHERE ipdial_code = "intcob-unisabaneta"
          ...
          ##  i = json.loads(datos)
            ...
            for rown in i['users']:
                file.write(
                    ...
                    str(rown["email"]).encode('utf-8').replace('\n', ' ').replace('\r', '').replace('&nbsp', '')+"|"+
    ...
    time.sleep(10)
    ejecutar = user_beam.run(output, KEY_REPORT) #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]    
    time.sleep(60)
