...
class formatearData(beam.DoFn):
	...
	def process(self, element):
		...
		tupla= {
				...
				'tel9':arrayCSV[24],
				'tel10':arrayCSV[24],
				'tel_extra':arrayCSV[25],
				'id_agent':arrayCSV[26],
				'fecha':arrayCSV[27],
				'llamadas':arrayCSV[28],
				'id_call':arrayCSV[29],
				'rellamada':arrayCSV[30],
				'resultado':arrayCSV[31],
				'cod_rslt1':arrayCSV[32],
				'cod_rslt2':arrayCSV[33],
				'rellamada_count':arrayCSV[34],
				'id_cliente':arrayCSV[35],
				'ipdial_code':arrayCSV[36],
				'rand_token':arrayCSV[37],
				'hora':arrayCSV[38],
				'id_campana':arrayCSV[39],
...
def run(output):
	...
	transformed | 'Escritura a BigQuery Telefonia' >> beam.io.WriteToBigQuery(
		gcs_project + ":telefonia.campaign", 
		schema=TABLE_SCHEMA, 
