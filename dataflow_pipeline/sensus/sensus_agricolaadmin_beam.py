...
TABLE_SCHEMA = (
	...
	'GOS:STRING, '
	'ID_RESULTADO:STRING, '
	'EC_REQUISITOS_DE_NEGOCIO___RESERVA_BANCARIA_POLITICA_DE_SEGURIDAD_DE_INFORMACION:STRING, '
	'EC_REQUISITOS_DE_NEGOCIO___INFORMACION_CORRECTA_Y_COMPLETA:STRING, '
	'EC_REQUISITOS_DE_NEGOCIO___ACTUALIZACION_DE_DATOS:STRING, '
	'EC_REQUISITOS_DE_NEGOCIO___SE_ADHIERE_A_LOS_LINEAMIENTOS_DE_ABANSA:STRING, '
	'EC_REQUISITOS_DE_NEGOCIO___CODIFICACION_COMPLETA_Y_CORRECTA_EN_TEK:STRING, '
	'EC_REQUISITOS_DE_NEGOCIO___CODIFICACION_COMPLETA_Y_CORRECTA_EN_TEMPUS:STRING, '
	...
	'ENC_HABILIDADES_BLANDAS___REALIZA_UN_ACUERDO_GANA___GANA_Y_LO_RATIFICA:STRING, '
	'ENC_HABILIDADES_BLANDAS___DEMUESTRA_ADECUADA_COMUNICACION_VERBAL_Y_URBANIDAD__TONO_DE_VOZ_VOLUMEN_Y_DICCION_:STRING, '
...
class formatearData(beam.DoFn):
	...
	def process(self, element):
		...
		tupla= {'idkey' : str(uuid.uuid4()),
				...
				'EC_REQUISITOS_DE_NEGOCIO___RESERVA_BANCARIA_POLITICA_DE_SEGURIDAD_DE_INFORMACION' : arrayCSV[29],
				'EC_REQUISITOS_DE_NEGOCIO___INFORMACION_CORRECTA_Y_COMPLETA' : arrayCSV[30],
				'EC_REQUISITOS_DE_NEGOCIO___ACTUALIZACION_DE_DATOS' : arrayCSV[31],
				'EC_REQUISITOS_DE_NEGOCIO___SE_ADHIERE_A_LOS_LINEAMIENTOS_DE_ABANSA' : arrayCSV[32],
				'EC_REQUISITOS_DE_NEGOCIO___CODIFICACION_COMPLETA_Y_CORRECTA_EN_TEK' : arrayCSV[33],
				'EC_REQUISITOS_DE_NEGOCIO___CODIFICACION_COMPLETA_Y_CORRECTA_EN_TEMPUS' : arrayCSV[34],
				...
				'ENC_HABILIDADES_BLANDAS___REALIZA_UN_ACUERDO_GANA___GANA_Y_LO_RATIFICA' : arrayCSV[41],
				'ENC_HABILIDADES_BLANDAS___DEMUESTRA_ADECUADA_COMUNICACION_VERBAL_Y_URBANIDAD__TONO_DE_VOZ_VOLUMEN_Y_DICCION_' : arrayCSV[42],
...
def run(archivo, mifecha):
	...
	transformed | 'Escritura a BigQuery Sensus_Banco' >> beam.io.WriteToBigQuery(
		gcs_project + ":sensus.agricolaadm", 
		schema=TABLE_SCHEMA, 	
