...
import time
import sys
import dataflow_pipeline.telefonia.iwdetail_beam as iwdetail_beam #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]

iwdetail_api = Blueprint('iwdetail_api', __name__) #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]
...
KEY_REPORT = "iw_detail" #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]
CODE_REPORT = "iw_detail" #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]
...
@iwdetail_api.route("/" + KEY_REPORT, methods=['GET']) #[[[[[[[[[[[[[[[[[[***********************************]]]]]]]]]]]]]]]]]]
def Ejecutar():
    ...
    for row in rows:
        ...
        if len(requests.get(url).content) < 50:
            ...
            for rown in i:
                file.write(
                    str(rown["skill"])+"|"+
                    str(rown["iw_date_inboundcall"])+"|"+                   
                    str(rown["iw_date_lastout"]).encode('utf-8')+"|"+
                    str(rown["status"])+"|"+
                    str(rown["calls"]).encode('utf-8')+"|"+
