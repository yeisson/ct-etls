...
class formatearData(beam.DoFn):
	...
	def process(self, element):
		...
		tupla= {'idkey' : str(uuid.uuid4()),
				...
				'DESCANSO2' : arrayCSV[18],
				'DESCANSO3' : arrayCSV[19],
				'HORAS_GESTION' : arrayCSV[20],
				'SEGMENTO' : arrayCSV[21],
				'TIEMPO_TOTAL_CAPACITACION' : arrayCSV[22],
				'ENTRENAMIENTO' : arrayCSV[23],
				'REUNION' : arrayCSV[24],
				'OBSERVACIONES' : arrayCSV[25],
				'HORAS_REU' : arrayCSV[26],
				'DESCANSOS' : arrayCSV[27],
				'DIFERENCIA_DESCANSO' : arrayCSV[28],
				'DIFERENCIA_DE_DESCANSO_INTERMEDIO' : arrayCSV[29],
				'DIFERENCIA_DESCANSO_FINAL' : arrayCSV[30],
