...
def run():
	...
	lines | 'Escribir en Archivo' >> WriteToText("archivos/Info_carga_negociadores", file_name_suffix='.csv',shard_name_template='')

	#transformed | 'Escribir en Archivo' >> WriteToText("archivos/Info_carga_negociadores", file_name_suffix='.csv',shard_name_template='')
	#transformed | 'Escribir en Archivo' >> WriteToText("gs://ct-bancolombia/negociadores/ASIGNACION_NEGOCIADORES_CONTENTO",file_name_suffix='.csv',shard_name_template='')
