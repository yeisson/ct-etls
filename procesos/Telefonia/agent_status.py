...
def Ejecutar():
    ...
    QUERY = (
        'SELECT servidor, operacion, token, ipdial_code, id_cliente, cartera FROM telefonia.parametros_ipdial where Estado = "Activado " and ipdial_code = "intcob-cisa-cobranza"') #WHERE ipdial_code = "intcob-unisabaneta"
